...
$_release = isset($_POST['group']) && $_POST['group'] == 'Release' ? true : false;
...
?>
        ...
        Releases <input type="radio" name="group" value="Release" <?= $_release ? "checked" : "" ?>><br>
        Team Iterations <input type="radio" name="group" value="TeamIteration" <?= !$_release ? "checked" : "" ?>><br>
    <input type="submit">
</form>
    <?php
