...
if (isset($_POST["team"])) {
    ...
    ?>
                Team: <input type="text" name="team"
                             value="<?php echo $_POST['team'] ?>"><br>
                Project: <input type="text" name="project"
                                value="<?php echo $_POST['project'] ?>"><br>
                From: <input type="text" name="from"
                             value="<?php echo $_POST['from'] ?>"><br>
                To: <input type="text" name="to"
                           value="<?php echo $_POST['to'] ?>"><br>
    <?php
    ...
    <html>
        <body>
            <form action="index.php" method="post">
                Team: <input type="text" name="team"
                             value="<?php echo "Stockmann" ?>"><br>
                Project: <input type="text" name="project"
                                value="<?php echo "Stockmann eCom #4" ?>"><br>
                From: <input type="text" name="from"
                             value="<?php echo $thisMonth ?>"><br>
                To: <input type="text" name="to"
                           value="<?php echo $nextMonth ?>"><br>
                Releases <input type="radio" name="group" value="Release" checked><br>
                Team Iterations <input type="radio" name="group" value="TeamIteration"><br>
                <input type="submit">
            </form>
